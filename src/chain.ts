 ...
 * @param networkID - Is a `Uint8Array` of 8 bytes that represents the network information containing type and id.
 ...
 */
function xorRailgun (networkID: Uint8Array) {
 ...
 * @param chain.type - The type of the chain.
 * @param chain.id - The ID of the chain.
 ...
 */
function getChainFullNetworkID ({ type, id }: Chain): Uint8Array {
 ...
 * @param networkID - It takes a `Uint8Array` parameter named
 ...
 */
function networkIDToChain (networkID: Uint8Array): Chain {
 ...
 * @param str - The `is0zk` function takes a string parameter `str` and asserts that it is of
